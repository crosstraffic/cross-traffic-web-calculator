<script>
  ...
  let losByApproach = $derived(results ? Object.fromEntries(results.approaches.map((a) => [a.direction, a.los])) : {});
    ...
    try {
      ...
      setReport({
        ...
        resultTable: {
          ...
          rows: results.approaches.map((ar) => [
            ar.direction,
            ar.flow_rate.toFixed(0),
            ar.control_delay_s.toFixed(1),
            ar.los,
          ]),
        },
        summary: [
...
<div class="hcm-page">
  <header class="page-header">
    ...
    <p class="page-sub">
      Estimate control delay and level of service for a four-leg pretimed signalized intersection, by approach and for
  ...
  <div class="alert alert-info shadow-sm mb-6 beta-note" role="note">
    <span>
      The compute engine reproduces the published HCM worked examples for this chapter. This page exposes a simplified
      pretimed configuration. Parking, bus stops, grades, platooning, and actuated phase timing are analyzed at their
      base values. Verify results independently before relying on them in engineering work, and please <a
    ...
    <section class="panel">
      <div class="panel-head">
        <div>
          ...
          <p class="panel-sub">
            Cycle timing and intersection-wide characteristics. Phase durations include the change period (G + Y + Rc),
            and the northbound and southbound approaches share one street phase pair with the eastbound and westbound
      ...
      <div class="diagram-block">
        <div class="diagram-head">
          <p class="panel-sub">
            Hover the legend to highlight an approach's movements. The picture follows the lane and phasing inputs, and
            in the 2D view the movement volumes can be edited directly on the diagram.
          </p>
      ...
      <section class="panel">
        <div class="panel-head">
          <div>
            ...
            <p class="panel-sub">
              Demand volumes, lanes, and phase durations for the {ap.key} approach. Set the left phase to 0 for a permitted
              left turn.
            </p>
          </div>
        </div>
