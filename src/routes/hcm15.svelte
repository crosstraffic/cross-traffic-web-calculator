...
// 
  ...
  let count = 0;
  let columns = ["Active", "Segment", "Passing Type", "Length", "Grade", "Horizontal Curves", "HC Params", "Demand Volums",
                  "Demand Volumns (O)", "Vertical Class"];
  let toggle_seg = -1;
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td>
              <input type="text" id="PHF_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="0.95" />
          </td>
        </tr>
        <tr>
          <td>Heavy Vehicle Percentage (%): </td>
          <td>
              <input type="text" id="PHV_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="5" />
          </td>
        </tr>
        <tr>
          <td>Posted Speed Limit (mi/hr): </td>
          <td>
              <input type="text" id="Spl_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="50" />
          </td>
        </tr>
        <tr>
          <td>Lane Width (ft): </td>
          <td>
              <input type="text" id="LW_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="3.6" />
          </td>
        </tr>
        <tr>
          <td>Shoulder Width (ft): </td>
          <td>
              <input type="text" id="SW_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="0.2" />
          </td>
        </tr>
        <tr>
          <td>Access Point Density (access points/mi): </td>
          <td>
              <input type="text" id="APD_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="2" />
          </td>
        </tr>
        <tr>
          <td>Percentage Multiplier for Heavy Vehicles in the Faster / Passing Lane: </td>
          <td>
              <input type="text" id="PMHVFL_input" placeholder="Type here" class="input input-label w-full max-w-xs" value="0.4" />
          </td>
        </tr>
      </tbody>
    </table>
