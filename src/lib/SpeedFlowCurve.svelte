...
<figure class="sfc">
  ...
  <svg viewBox="0 0 {W} {H}" role="img" preserveAspectRatio="xMidYMid meet"
    ...
    <text class="sfc-axis" transform={`translate(11 ${PAD.top + plotH / 2}) rotate(-90)`} text-anchor="middle">Speed (mi/h)</text>
...
<style>
  ...
  .sfc svg { width: 100%; height: auto; display: block; overflow: visible; }

  .sfc-grid { stroke: currentColor; stroke-width: 1; opacity: 0.09; }
  .sfc-tick { font-size: 9px; fill: currentColor; opacity: 0.5; font-variant-numeric: tabular-nums; }
  .sfc-axis { font-size: 9px; fill: currentColor; opacity: 0.5; }

  .sfc-ref { stroke: currentColor; stroke-width: 1; stroke-dasharray: 3 4; opacity: 0.3; }
  .sfc-ref-cap { opacity: 0.45; }
  .sfc-ref-label { font-size: 8.5px; fill: currentColor; opacity: 0.5; }

  .sfc-curve { fill: none; stroke: #256abf; stroke-width: 2; stroke-linecap: round; }

  .sfc-drop { stroke: currentColor; stroke-width: 1; stroke-dasharray: 2 3; opacity: 0.35; }
  ...
  .sfc-pt-ring { fill: var(--sfc-surface, #fcfcfb); }
  .sfc-pt { fill: #256abf; }
  .sfc-pt-label { font-size: 10px; font-weight: 600; fill: currentColor; }
  .sfc-over { font-size: 11px; fill: #d03b3b; font-weight: 600; }
</style>
