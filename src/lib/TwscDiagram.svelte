...
<div class="twsc-diagram">
  ...
  <svg
    viewBox="0 {threeLeg ? boxN - 40 : 0} {W} {threeLeg ? H - boxN + 40 : H}"
  ...
  <p class="tw-note">
    The dash pattern shows the HCM rank: solid rank 1 (major through and right), long dashes rank 2 (major left, minor
    right), short dashes rank 3, dotted rank 4. Lower rank yields to everything above it. Animated traffic runs the
    major street free and, after a run, crawls the minor approaches by their LOS. An illustration, not a simulation.
  </p>
</div>
...
<style>
  ...
  .tw-cluster input:disabled {
    opacity: 0.35;
  }
  .tw-cluster input::-webkit-outer-spin-button,
  .tw-cluster input::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
  }
  .tw-cluster input[type='number'] {
