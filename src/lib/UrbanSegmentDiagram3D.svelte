<script>
  ...
  let { nThroughLanes = 2, accessSubject = 4, accessOpposing = 4, control = 'signalized', los = null } = $props();
...
<div class="us-diagram-3d">
  ...
  {#if los}
    <div class="us3-legend">
      <span class="us3-chip"
        ><span class="swatch" style="background: {losFill}"></span>Subject direction, LOS {los}</span
      >
    </div>
  {/if}
</div>
