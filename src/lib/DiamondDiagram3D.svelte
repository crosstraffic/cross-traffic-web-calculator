  ...
  function buildPaths(form, ebOut, ebIn, wbOut, wbIn, yI, yJ, stubs) {
    ...
    const common = {
      B: [
        at(stubs.nbOff, 1),
        at(stubs.nbOff, 0.15),
        ...q(at(stubs.nbOff, 0.15), [xE + 4, ebOut], [xE + 26, ebOut]),
        [W, ebOut],
      ],
      C: [
        at(stubs.sbOff, 1),
        at(stubs.sbOff, 0.15),
        ...q(at(stubs.sbOff, 0.15), [xW - 4, wbOut], [xW - 26, wbOut]),
        [0, wbOut],
      ],
      F: [
        [0, ebOut],
        [xW - 26, ebOut],
        ...q([xW - 26, ebOut], [xW + 2, ebOut], at(stubs.sbOn, 0.15)),
        at(stubs.sbOn, 1),
      ],
      G: [
        [W, wbOut],
        [xE + 26, wbOut],
        ...q([xE + 26, wbOut], [xE - 2, wbOut], at(stubs.nbOn, 0.15)),
        at(stubs.nbOn, 1),
      ],
    };
    if (form === 'Ddi') {
      return {
        ...
        A: [
          at(stubs.nbOff, 1),
          at(stubs.nbOff, 0.1),
          ...q(at(stubs.nbOff, 0.1), [xE - 2, wbS], [xE - 26, wbS]),
          [xW + 30, wbS],
          ...q([xW + 30, wbS], [xW + 6, wbS + (wbIn - wbS) / 2], [xW - 26, wbIn]),
          [0, wbIn],
        ],
        D: [
          at(stubs.sbOff, 1),
          at(stubs.sbOff, 0.1),
          ...q(at(stubs.sbOff, 0.1), [xW + 2, ebN], [xW + 26, ebN]),
          [xE - 30, ebN],
          ...q([xE - 30, ebN], [xE - 6, ebN + (ebIn - ebN) / 2], [xE + 26, ebIn]),
          [W, ebIn],
        ],
        E: [
          [0, ebIn],
          [xW - 30, ebIn],
          ...q([xW - 30, ebIn], [xW - 6, (ebIn + ebN) / 2], [xW + 26, ebN]),
          [xE - 30, ebN],
          ...q([xE - 30, ebN], [xE - 4, ebN], at(stubs.nbOn, 0.14)),
          at(stubs.nbOn, 1),
        ],
        H: [
          [W, wbIn],
          [xE + 30, wbIn],
          ...q([xE + 30, wbIn], [xE + 6, (wbIn + wbS) / 2], [xE - 26, wbS]),
          [xW + 30, wbS],
          ...q([xW + 30, wbS], [xW + 4, wbS], at(stubs.sbOn, 0.13)),
          at(stubs.sbOn, 1),
        ],
        I: [
          [0, yI],
          [xW - 30, yI],
          ...q([xW - 30, yI], [xW - 6, (yI + ebN - 6) / 2], [xW + 26, ebN - 6]),
          [xE - 30, ebN - 6],
          ...q([xE - 30, ebN - 6], [xE - 6, (yI + ebN - 6) / 2], [xE + 26, yI]),
          [W, yI],
        ],
        J: [
          [W, yJ],
          [xE + 30, yJ],
          ...q([xE + 30, yJ], [xE + 6, (yJ + wbS + 6) / 2], [xE - 26, wbS + 6]),
          [xW + 30, wbS + 6],
          ...q([xW + 30, wbS + 6], [xW + 6, (yJ + wbS + 6) / 2], [xW - 26, yJ]),
          [0, yJ],
        ],
      };
    }
