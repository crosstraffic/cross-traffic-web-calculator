...
* @returns {any}
*/
export function segment_ramp_section(gore_to_gore_ft: number, has_auxiliary_lane: boolean): any;
/**
...
*/
export function ramp_service_flow_rate_ideal(template: WasmRampSegment, basis: any, target_density: number): number | undefined;
/**
...
* @returns {any}
*/
export function ramp_service_volumes(sfi: number, f_hv: number, f_p: number, phf: number): any;
/**
...
export interface InitOutput {
  ...
  readonly segment_ramp_section: (a: number, b: number, c: number) => void;
  readonly ramp_influence_area_ft: () => number;
  ...
  readonly ramp_service_flow_rate_ideal: (a: number, b: number, c: number, d: number) => void;
  readonly ramp_service_volumes: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly wasmfreewayreliability_set_incidents: (a: number, b: number, c: number) => void;
  readonly wasmfreewayreliability_clear_incidents: (a: number) => void;
  readonly wasmfreewayreliability_has_incidents: (a: number) => number;
  readonly wasmfreewayreliability_incident_duration_params: (a: number) => number;
